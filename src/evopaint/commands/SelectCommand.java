...
public class SelectCommand extends AbstractCommand {
    ...
    public void setLocation(Point userSpaceLocation) {
        if (startPoint == null) startPoint = userSpaceLocation;
        mouseLocation = userSpaceLocation;
        ...
        bounds = new Rectangle(leftPoint1.x, leftPoint1.y, rightPoint1.x - leftPoint1.x, rightPoint1.y - leftPoint1.y);
    ...
    public void execute() {
        ...
        if (s == null) return;
        Selection selection = new Selection(bounds, canvas);
