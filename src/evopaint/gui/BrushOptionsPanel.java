...
public class BrushOptionsPanel extends JPanel {
    ...
    public BrushOptionsPanel(Configuration configuration) {
        ...
        Dimension dim = configuration.getDimension();
        SpinnerNumberModel spinnerModel = new SpinnerNumberModel(configuration.brush.size, 1, Math.min(dim.width, dim.height), 1);
