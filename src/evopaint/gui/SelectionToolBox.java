...
import evopaint.commands.SetSelectionNameCommand;

/**
 * Specification of a selection observer
 *
...
public class SelectionToolBox extends JPanel implements Observer {
    ...
    private class SelectionWrapper extends JPanel implements Observer, MouseListener {
        ...
        public void mouseEntered(MouseEvent arg0) {
            if (selection != showcase.getActiveSelection()) {
        ...
        public void mousePressed(MouseEvent arg0) {
            if (arg0.getClickCount() == 2 && !arg0.isConsumed()) {
                new SetSelectionNameCommand(showcase2).execute();
        ...
        private void showContextMenu(MouseEvent arg) {
            ...
            setName.addActionListener(new SetSelectionNameCommand(showcase2));
            menu.add(setName);
